...
<div class="columns">
  ...
  <input id="text" type="text"  style="display: none;" placeholder=" Enter something...">
    ...
    <form action="controls/ctrl-add-item.php" name="family_form" method="POST" enctype="multipart/form-data">
        ...
        <table id="ttable" class="table table-striped table-hover">
            ...
            <tr>
                ...
                <td>
                    <div class="form-group">
                        <input class="form-input text password-opener password tamil" type="text" id="t_name1[]" name="t_name[]" placeholder="bghUs;">
                    </div>
                </td>
...
include('db_info.php');
$i=1;
$results = $db->query("SELECT * from item_list  order by item_name");
while ($row = $results->fetchArray()) {

echo '<a href="edit_item.php?id='.$row['id'].'"><span class="chip tamil">'.$row['tamil_name'].'</span></a>';
